...
export function BrowserPreview({ currentUrl, agentState }: BrowserPreviewProps) {
  return (
    <div className="glass-panel flex-1 flex flex-col overflow-hidden relative border border-neural-border/50 shadow-2xl">
=======
          ...
          {currentUrl.includes('ads.google.com') ? (
            <div className="space-y-6">
              ...
              <div className="h-64 bg-gray-50 rounded-lg border border-gray-200 flex items-center justify-center">
                <span className="text-gray-400 font-medium">Gráfico de Desempenho</span>
              </div>
            </div>
